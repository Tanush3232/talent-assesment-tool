  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-slate-900">Global Talent Directory</h1>
          <p className="text-slate-500 mt-1 text-sm">
            Consolidated view of all <span className="text-zuari-blue font-semibold">active departmental units</span> across regional centers.
          </p>
        </div>
